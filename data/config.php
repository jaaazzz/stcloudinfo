...
$base_url_config = array(
    "file_server" => "http://10.8.9.192/",//文件服务器外网地址
    ...
    //"iggs_api_url"    => "http://192.168.11.47:8181/rest/api",  //获取iggs数据服务地址
    "iggs_api_url"    => "http://10.8.9.192:8181/rest/api",  //获取iggs数据服务地址
