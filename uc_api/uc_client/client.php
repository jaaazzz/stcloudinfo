 ...
 * @param int $page_total 页码总数
 * @param int $num_total 记录总数
 * @param string $sql_where 查询条件
 * @return string
 */
function uc_get_user_list($page,$page_size,$page_total,$num_total,$sql_where)
{
    $res = uc_api_post('user','getuserlist',Array(
        'page'=>$page,
        'page_size'=>$page_size,
