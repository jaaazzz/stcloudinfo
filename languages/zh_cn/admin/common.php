...
$_LANG['copyright'] = '版权所有 &copy; 2005-2014 中地数码科技有限公司，并保留所有权利。Powered By platformX';
...
$_LANG['17_gisstore_operation'] = '工具超市工具';
$_LANG['18_service'] = '服务管理';
$_LANG['19_service_order'] = '服务订单管理';
$_LANG['20_service_sold_out'] = '服务下架管理';
$_LANG['gisstore_operation_batching'] = "批处理操作";
$_LANG['gisstore_base_plugin'] = "基础插件管理";
$_LANG['gisstore_earning'] = "收益管理";

/* 服务管理 */
$_LANG['01_tech_service_review'] = '技术服务审核';
$_LANG['02_train_service_review'] = '培训服务审核';
$_LANG['03_material_service_review'] = '材料审核';
$_LANG['04_all_review'] = '服务产品列表';
$_LANG['review_info'] = '审核信息';
$_LANG['06_all_order'] = '服务产品订单列表';
$_LANG['04_tech_order_list'] = '技术服务订单列表';
$_LANG['05_train_order_list'] = '培训服务订单列表';
$_LANG['service_list_info'] = '订单信息';
$_LANG['06_tech_service_sold'] = '技术服务下架列表';
$_LANG['07_train_service_sold'] = '培训服务下架列表';
$_LANG['08_material_service_sold'] = '图文资料下架列表';
$_LANG['09_refund_audit'] = '退款仲裁审核';
...
$_LANG['53_exchange'] = '积分兑换';
$_LANG['54_goods_export'] = '商品导出';
$_LANG['54_goods_import'] = '商品导入';
$_LANG['55_goods_image'] = '图片标准化';
