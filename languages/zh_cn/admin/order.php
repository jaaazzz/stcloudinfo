...
$_LANG['cs'][GOP_NOTPAID] = '未付款';
$_LANG['cs'][GOP_PAID] = '已付款';
$_LANG['cs'][GOP_CANCEL] = '已取消';
//$_LANG['cs'][GOP_TRIAL] = '试用版';
//

/* GISStore */
$_LANG['ot'][GOT_FIRST] = '全新购买';
$_LANG['ot'][GOT_RENEW] = '续费';
$_LANG['ot'][GOT_REASSEMBLE] = '重新选配';
...
/* invoice */
$_LANG['invoice_type'][INVOICE_TYPE_NORMAL] = '普通发票';
$_LANG['invoice_type'][INVOICE_TYPE_VAT] = '增值税发票';

/* invoice title */
$_LANG['invoice_title_type'][INVOICE_TITLE_TYPE_PERSONAL] = '个人';
$_LANG['invoice_title_type'][INVOICE_TITLE_TYPE_UNIT] = '单位';
