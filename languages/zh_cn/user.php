...
$_LANG['email_noexit'] = '您填写的电子邮件地址不正确，请重新输入！';
$_LANG['fail_send_password'] = '发送邮件出错，请与管理员联系！';
$_LANG['send_success'] = '重置密码的邮件已经发到您的邮箱：';
$_LANG['send_email_validate'] = '账户激活的邮箱已经发送到您的邮箱：';
$_LANG['send_email_validate_title'] = '工具集邮箱验证';
$_LANG['send_email_validate_add'] = '请在24小时内登录邮箱，按邮箱中的提示激活账户';
$_LANG['password_find_title'] = '工具集密码找回';
$_LANG['password_find_message'] = '请在24小时内登录邮箱，按邮箱中的提示找回密码';
...
$_LANG['msg_un_length'] = '最长可输入14个英文或7个汉字';
...
$_LANG['passport_js']['msg_un_length'] = '最长可输入14个英文或7个汉字';
