...
class captcha
{
    ...
    var $themes_jpg = array(
        1 => array('1.jpg', 135, 135, 135),
        2 => array('2.jpg', 135, 135, 135),
        3 => array('3.jpg', 135, 135, 135),
        4 => array('4.jpg', 135, 135, 135),
        5 => array('5.jpg', 135, 135, 135),
    );

    var $themes_gif = array(
        1 => array('captcha_bg1.gif', 135, 135, 135),
        2 => array('captcha_bg2.gif', 135, 135, 135),
        3 => array('captcha_bg3.gif', 135, 135, 135),
        4 => array('captcha_bg4.gif', 135, 135, 135),
        5 => array('captcha_bg5.gif', 135, 135, 135),
    );
     ...
     * @return  bool
     */
    function captcha_($folder = '', $width = 145, $height = 20)
    {
        if (!empty($folder))
        {
            $this->folder = $folder;
    ...
    {
        $this->captcha_($folder, $width, $height);
    }
