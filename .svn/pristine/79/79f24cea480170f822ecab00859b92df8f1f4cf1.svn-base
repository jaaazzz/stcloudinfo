 ...
 * 上海创极 管理员信息以及权限管理程序
 * ============================================================================
 * * 版权所有 2005-2012 上海创极信息科技有限公司，并保留所有权利。
 * 网站地址: http://www.zhice.org；
 * ----------------------------------------------------------------------------
 * 这不是一个自由软件！您只能在不用于商业目的的前提下对程序代码进行修改和
 * 使用；不允许对程序代码以任何形式任何目的的再发布。
 * ============================================================================
 * $Author: liubo $
 * $Id: privilege.php 17217 2016-01-19 06:29:08Z liubo $
*/
...
//    }
    ...
    {
         /* 检查密码是否正确 */
         $sql = "SELECT role_list,user_id, user_name, password, last_login, action_list, last_login,suppliers_id,ec_salt".
    ...
    if ($row)
    {
        ...
        $_SESSION['role_list'] =$row['role_list'];
...
{
    $list = array();
    $sql  = 'SELECT user_id,role_list, user_name, email, add_time, last_login '.
