...
$_LANG['prev_step'] = '上一步：';
$_LANG['next_step'] = '下一步：';
$_LANG['copyright'] = '&copy; 2011-2016 <a href="http://www.mapgis.com" target="_blank">武漢中地數碼科技有限公司</a>。保留所有權利。';
...
$_LANG['db_list'] = '已有數據庫';
$_LANG['db_prefix'] = '表前綴：';
$_LANG['change_prefix'] = '';//原始：建議您修改表首綴
...
$_LANG['pwd_middle'] = '中';
$_LANG['pwd_high'] = '強';
$_LANG['file_host'] = '文件服務器地址：';
$_LANG['dog_host'] = "私有雲狗地址：";
$_LANG['local_host'] = "本地站點地址：";
...
$_LANG['file_host_empty_error'] = '文件服務器地址不能爲空';
$_LANG['dog_host_empty_error'] = '私有云狗地址不能爲空';
$_LANG['local_host_empty_error'] = '本站站点地址不能爲空';
$_LANG['openstack_host_empty_error'] = 'openstack地址不能爲空';
$_LANG['admin_name_empty_error'] = '管理員姓名不能爲空';
