...
/**
 * Tom added 2013-6-13 16:37:33
 * 增加一些gis用到的错误类型 * 
 */
define('ERR_CART_ADDON_TYPE',		7);// 添加的插件不能和购物车里已有的进行定制
...
define("GOT_FIRST",0);
define("GOT_RENEW",1);
define("GOT_REASSEMBLE",2);


//wenbaolin 2014.08.07 add 购买开发者授权
define("GOT_DEV",9);
//sunanguang 2014.08.29 add 购买积分
define("GOT_SCORE", 10);
//songdingding 2015.04.09 add 购买服务
define("GOT_SERVICE", 11);

/* 常量 gis order pay */
define('GOP_NOTPAID',0);
define('GOP_PAID',1);	
define('GOP_CANCEL',2);	
...
/* 常量 地址类型  */
define("ADDRESS_TYPE_GOODS",0);//商品地址
define("ADDRESS_TYPE_INVOICE",1);//发票地址

/* 常量 发票类型 */
define("INVOICE_TYPE_NORMAL",0);//普通发票
define("INVOICE_TYPE_VAT",1);//增值税发票

/* 常量 发票抬头类型 */
define("INVOICE_TITLE_TYPE_PERSONAL",0);//个人发票抬头
define("INVOICE_TITLE_TYPE_UNIT",1);//单位发票抬头

/* 注册或更新权限的时候记录历史 */
define("CD_AUTH_TYPE_REG",1);//register
define("CD_AUTH_TYPE_UPDATE",2);//update
?>