...
class alipay_for_service
{
    ...
    {
        $this->_alipay_for_service();
    }


    /**
     * Tom added 2013-6-26 20:43:23
     * 和get_code完全i样！！
     * @param  [type] $order   [description]
     * @param  [type] $payment [description]
     * @return [type]          [description]
     */
    function get_url($order, $payment){
        ...
        $parameter = array(
            ...
            "notify_url"        => return_service_url(basename(__FILE__, '.php')),
            'return_url'        => return_service_url(basename(__FILE__, '.php')),
            /* 业务参数 */
            /* Tom 2013-8-2 10:25:26 */
    ...
    function service_respond()
    {
        ...
        /* 检查支付的金额是否相符 */
        if (!check_pay_money($order_sn, $_GET['total_fee'], $_GET['service_type']))
        {
            return false;
        }


        //指纹正确，支付的金额是否相符，则说明支付完成。
        //修改订单状态的工作，在其他地方完成。
        return true;
