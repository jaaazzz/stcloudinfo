...
listTable.toggle = function(obj, act, id)
{
  ...
  if(res.notes && window.console && window.console.error){
    window.console.error("sync to devcenter::down-shelf-error:" + res.notes);
  }
  this.loadList();
}
...
listTable.listCallback = function(result, txt)
{
  ...
  else
  {
    ...
    //{
      ...
      if(setCheckBox && typeof(setCheckBox) == "function")
      {
          setCheckBox();
      }
    }
