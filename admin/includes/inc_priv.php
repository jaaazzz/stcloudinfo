...
//商品管理权限
    ...
    $purview['54_goods_export']      = 'goods_export';
    $purview['55_goods_image']       = 'goods_image';
...
//服务管理
    $purview['01_tech_service_review']= 'goods_manage';
    $purview['02_train_service_review']= 'goods_manage';
    $purview['03_material_service_review']= 'goods_manage';

    $purview['04_tech_order_list']= 'order_view';
    $purview['05_train_order_list']= 'order_view';
    $purview['09_refund_audit']= 'order_view';

    $purview['06_tech_service_sold']= 'goods_manage';
    $purview['07_train_service_sold']= 'goods_manage';
    $purview['08_material_service_sold']= 'goods_manage';
...
//邮件群发管理
    ...
    $purview['gisstore_operation_batching']        = 'gisstore_operation_batching';
    $purview['gisstore_base_plugin']        = 'gisstore_base_plugin';
