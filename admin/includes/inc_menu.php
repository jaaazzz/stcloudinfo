...
$modules['02_cat_and_goods']['53_exchange']                        = 'exchange_goods.php?act=list';//
$modules['02_cat_and_goods']['54_goods_import']                    = 'goods_batch.php?act=import';
//$modules['02_cat_and_goods']['54_goods_export']                    = 'goods.php?act=export';//商品导出
$modules['02_cat_and_goods']['54_goods_export']                    = 'goods_export.php?act=export';//商品导出
//$modules['02_cat_and_goods']['55_goods_image']                     = 'goods_image.php?act=init';//图片标准化
...
$modules['04_order']['02_order_list']                              = 'order.php?act=gis_list';
...
$modules['10_priv_admin']['user_log']                              = 'user_logs.php?act=list';
...
//$modules['17_gisstore_operation']['gisstore_operation_batching'] = 'gisstore.php?mod=batching';
$modules['17_gisstore_operation']['gisstore_base_plugin']          = 'gisstore.php?mod=base_plugin';
$modules['17_gisstore_operation']['gisstore_earning']              = 'gisstore.php?mod=earning';	


// $modules['18_service']['01_tech_service_review']                        = 'services_review.php?mod=1';
// $modules['18_service']['02_train_service_review']                        = 'services_review.php?mod=2';
$modules['18_service']['03_material_service_review']                        = 'services_review.php?mod=3';
$modules['18_service']['04_all_review']                                  = 'services_review.php?mod=0';

$modules['19_service_order']['04_tech_order_list']                        = 'service_order_list.php?mod=1';
$modules['19_service_order']['05_train_order_list']                        = 'service_order_list.php?mod=2';
$modules['19_service_order']['06_all_order']                                  = 'service_order_list.php?mod=0';
$modules['19_service_order']['09_refund_audit']                                  = 'service_refund_audit.php?mod=list';


// $modules['20_service_sold_out']['06_tech_service_sold']                        = 'services_sold_out.php?mod=1';
// $modules['20_service_sold_out']['07_train_service_sold']                        = 'services_sold_out.php?mod=2';
$modules['20_service_sold_out']['08_material_service_sold']                        = 'services_sold_out.php?mod=3';
