...
function createConfigFile() {
    var f = $("js-setting"),
        ...
        params="db_host=" + f["js-db-host"].value + "&"
            ...
            + "file_host=" + f["js-file-host"].value + "&"
            + "dog_host=" + f["js-dog-host"].value + "&"
            + "local_host=" + f["js-local-host"].value + "&"
            + "openstack_host=" + f["js-openstack-host"].value + "&"
            + "system_manager_host=" + f["js-system-manager-host"].value + "&"
            + tz + "&"
            + "lang=" + getAddressLang() + "&"
            + "IS_AJAX_REQUEST=yes";
