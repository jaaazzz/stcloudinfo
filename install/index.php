...
case 'create_config_file' :
    ...
    $file_host  = isset($_POST['file_host'])    ?   trim($_POST['file_host']) : '';
    $dog_host   = isset($_POST['dog_host'])    ?   trim($_POST['dog_host']) : '';
    $local_host = isset($_POST['local_host'])    ?   trim($_POST['local_host']) : '';
    $openstack_host  = isset($_POST['openstack_host'])    ?   trim($_POST['openstack_host']) : '';
    $system_manager_host  = isset($_POST['system_manager_host']) ? trim($_POST['system_manager_host']) : '';

    $result = create_config_file($db_host, $db_port, $db_user, $db_pass, $db_name, $prefix, $timezone, $file_host, $dog_host, $local_host, $openstack_host,$system_manager_host);
    if ($result === false)
    {
