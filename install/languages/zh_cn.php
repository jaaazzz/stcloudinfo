...
$_LANG['prev_step'] = '上一步：';
$_LANG['next_step'] = '下一步：';
$_LANG['copyright'] = '&copy; 2011-2016 <a href="http://www.mapgis.com" target="_blank">武汉中地数码科技有限公司</a> 保留所有权利 ';
...
$_LANG['db_list'] = '已有数据库';
$_LANG['db_prefix'] = '表前缀：';
$_LANG['change_prefix'] = '';//原始：建议您修改表前缀
...
$_LANG['pwd_middle'] = '中';
$_LANG['pwd_high'] = '强';
$_LANG['file_host'] = '文件服务器地址：';
$_LANG['dog_host'] = "私有云狗地址：";
$_LANG['local_host'] = "本地站点地址：";
$_LANG['openstack_host'] = "openstack地址：";
//增加后台管理系统地址
$_LANG['system_manager_host'] = "后台管理系统地址：";
...
$_LANG['file_host_empty_error'] = '文件服务器地址不能为空';
$_LANG['dog_host_empty_error'] = '私有云狗地址不能为空';
$_LANG['local_host_empty_error'] = '本站站点地址不能为空';
$_LANG['openstack_host_empty_error'] = 'openstack地址不能为空';
$_LANG['admin_name_empty_error'] = '管理员姓名不能为空';
...
$_LANG['js_languages']['file_empty_error'] = '文件服务器地址不能为空';
$_LANG['js_languages']['dog_empty_error'] = '私有云狗地址不能为空';
$_LANG['js_languages']['local_empty_error'] = '本站站点地址不能为空';
$_LANG['js_languages']['openstack_empty_error'] = 'openstack地址不能为空';
$_LANG['js_languages']['address_error'] = '地址格式不正确';
